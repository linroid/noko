...
JNIEXPORT jint JNI_OnLoad(JavaVM *vm, void *) {
  ...
  NodeClass.attach = env->GetMethodID(clazz, "attach", "(Lcom/linroid/noko/js/JSContext;)V");
  NodeClass.detach = env->GetMethodID(clazz, "detach", "(Lcom/linroid/noko/js/JSContext;)V");
